...
<?php 
include ('../cnn.php');
$consulta="SELECT * FROM tcategoria";
...
echo "<br>";
                            ...
                            echo "<table>";
                            echo "<tr>";
                            echo "<td><form action='../Reportes/reporte.php' method='post' target='_blank'><input type='text' name='txtFec2'  style='display: none' ><input type='image' src='../img/pdf.png' width='80' height='60' ></form>";
                            echo "</td>";
                            echo "</tr>";
                            echo "</table>";
//echo "<table border='2' >";
...
<table width="90%" border="0">
	<tr align="center">
		<form>
			<td>
				<a href="icategoria.php"><input type="button" name="btnPais" value="AGREGAR" class="botonA"></a>
			</td>
            <td>
                <a href="bcategoria.php"><input type="button" name="btnPais" value="BUSCAR" class="botonA"></a>
            </td>
		<td>
