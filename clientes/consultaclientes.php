...
$resultado=mysqli_query($conn,$consulta);
        ...
        echo "<table>";
        echo "<tr>";
        echo "<td><form action='../Reportes/rclientes.php' method='post' target='_blank'><input type='text' name='txtFec2'  style='display: none' ><input type='image' src='../img/pdf.png' width='80' height='60' ></form>";
        echo "</td>";
        echo "</tr>";
        echo "</table>";
