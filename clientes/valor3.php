...
<?php 
$consulta="SELECT clientes.id_cliente, clientes.nit, clientes.nombre,clientes.apellido,clientes.cestado FROM clientes
    WHERE  clientes.apellido LIKE '%".$buscar."%' ";
					...
					while($columna=mysqli_fetch_array($resultado)){
                        ...
                        <td align='center'><font size='2'>".$columna['nit']."</font></td>
                        <td align='center'><font size='2'>".$columna['nombre']."</font></td>
                        <td align='center'><font size='2'>".$columna['apellido']."</font></td>
                        <td align='center'><font size='2'>".$columna['cestado']."</font></td>
                        <td style='height: 25px;' align='center'><a href='bclientes.php?codigo=".$columna['id_cliente']."'>
                        <input type='submit' name='btnupdate' value='EDITAR' class='botonE'></a></td>
                        <td style='height: 25px;' align='center'><a href='delclientes.php?codigo=".$columna['id_cliente']."'>
